...
const words = [
  ...
  { text: "Security", imgPath: "/images/designs.svg" },
...
const counterItems = [
  ...
  { value: 100, suffix: "%", label: "Commitment to Security" },
];
...
const abilities = [
  {
    ...
    desc: "Building end-to-end web and mobile solutions with React, Rails, Node.js, Flutter, and more.",
  },
  {
    imgPath: "/images/chat.png",
    title: "Cybersecurity & VAPT",
    desc: "Ethical hacking, vulnerability assessments, and secure coding practices to protect applications.",
  },
  {
    imgPath: "/images/time.png",
    title: "DevOps & CI/CD",
    desc: "Automating pipelines with Jenkins, Docker, and CI/CD to ensure fast and reliable deployments.",
  },
];
